...
| 2026-09-22 | `alt.plataforma.evidencias` | Evidências estatísticas no painel do Mentor IAVA: saldo do período, taxa de acerto de 54,3%, drawdown máximo e melhor trade *(proposto pelo Claude Code, aguardando aprovação)* | Painel de evidências estatísticas do Mentor IAVA com saldo do período, taxa de acerto, drawdown máximo e melhor trade — **APROVADO pelo Gustavo** | Gustavo |
| 2026-09-22 | `alt.plataforma.chat` | Conversa com o Mentor IAVA: o trader pergunta “Como eu posso melhorar?” e recebe ajustes baseados nas próprias operações *(proposto pelo Claude Code, aguardando aprovação)* | Conversa com o Mentor IAVA: o trader pergunta “Como eu posso melhorar?” e recebe ajustes baseados nas próprias operações — **APROVADO pelo Gustavo** | Gustavo |
| 2026-09-22 | `meta.imagem-og` | *(pendente: imagem de compartilhamento 1200×630)* | *(resolvido: img/og-mentor-iava.jpg, captura da hero composta para 1200×630 — scripts/gerar-og.mjs; og:image e twitter:image com URL absoluta)* | Gustavo |
| 2026-09-22 | `cookies.texto` | *(não existia)* | Usamos cookies para medir o desempenho dos nossos anúncios e melhorar sua experiência. Saiba mais na nossa Política de Privacidade. ("Política de Privacidade" é link para https://zero7.com.br/politica-de-privacidade/) — **aprovado pelo Gustavo** | Gustavo |
| 2026-09-22 | `cookies.aceitar`, `cookies.recusar` | *(não existiam)* | Aceitar · Recusar (botões do aviso de cookies) — **aprovados pelo Gustavo** | Gustavo |
...
| 2026-09-22 | `cookies.texto`, `cookies.aceitar`, `cookies.recusar` | *(aviso de cookies aprovado)* | *(removidos: o Pixel passa a disparar sem pedir consentimento — decisão do Gustavo; implementação guardada em docs/aviso-cookies.md)* | Gustavo |
| 2026-09-22 | `rodape.cookie` | Cookie *(reabria o aviso de cookies)* | Cookie *(de volta ao href vazio, cópia da home)* | Gustavo |
